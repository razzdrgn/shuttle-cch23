...
This is a fucked one. I'm extremely tired since I worked on this for roughly 6 hours straight after work. Maybe I should find a way to bring my dev environment into the office.

Anyway. God this one was brutal. Figuring out how to work the tar crate with axum's bytestreams was rough until I found the specific crate I had to use, then doing everything with tempfile for the second challenge, and THEN AGAIN I had to refactor the fuckin. Entire Damn Thing to work recursively because the way the git2 crate handles the parents iterator kinda sucks. And then on top of that I had to figure out how to properly walk over the tree objects. Plus like, the nonsensical data borrowing lifetimes for trying to do all the type conversions. Like hey buddy, unless I'm specifically storing you in a let, I don't care! But that's just me complaining about Rust's Good Features because I'm extremely tired. Now if you'll excuse me I have to go and get like, 6 hours of sleep. I hope.